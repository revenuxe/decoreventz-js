...
export default async function EmailDeliveryPage() {
  ...
  return <section className="space-y-5">
    <div><h1 className="font-display text-3xl">Email delivery</h1><p className="mt-2 text-sm text-muted-foreground">Booking updates go only to decoreventz.com@gmail.com. Customer and vendor notifications are disabled. Latest 100 notifications are shown.</p></div>
