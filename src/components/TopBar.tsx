...
export function TopBar() {
  ...
  return (
    <header className="sticky inset-x-0 top-0 z-40 border-b border-[#e8edf3] bg-white shadow-sm">
      ...
      <nav aria-label="Browse event categories" className="hidden border-t border-[#edf0f4] md:block"><div className="mx-auto flex max-w-none items-center gap-7 px-12 py-3 xl:px-16">{NAV_ITEMS.map((item) => {
