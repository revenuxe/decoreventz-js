  ...
  return (
    ...
    >
      <div className="relative min-h-0 flex-1 overflow-hidden bg-muted">
        {image ? <Image src={image} alt={tagline ? `${name} — ${tagline}` : name} fill unoptimized loading="lazy" sizes="(min-width: 768px) 16vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-110" /> : <div className="h-full w-full bg-gradient-brand" />}
